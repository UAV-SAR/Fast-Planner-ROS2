...
int main(int argc, char** argv) {
  ...
  node->declare_parameter("obj_generator/xy_size", 10.0);
  node->declare_parameter("obj_generator/h_size", 5.0);
  node->declare_parameter("obj_generator/vel", 1.0);
  node->declare_parameter("obj_generator/yaw_dot", 0.5);
  node->declare_parameter("obj_generator/acc_r1", 0.5);
  node->declare_parameter("obj_generator/acc_r2", 1.0);
  node->declare_parameter("obj_generator/acc_z", 0.5);
  node->declare_parameter("obj_generator/scale1", 0.2);
  node->declare_parameter("obj_generator/scale2", 0.5);
  node->declare_parameter("obj_generator/interval", 0.5);
  ...
  rclcpp::TimerBase::SharedPtr update_timer = node->create_wall_timer(std::chrono::duration<double>(1.0 / 30.0), &updateCallback);

...
{
public:
  explicit Init_Odometry_curodom(::quadrotor_msgs::msg::Odometry & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_Odometry_curodom header(::quadrotor_msgs::msg::Odometry::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_Odometry_curodom(msg_);
  }
...
{
  return quadrotor_msgs::msg::builder::Init_Odometry_header();
}

...
struct has_fixed_size<quadrotor_msgs::msg::Odometry>
  : std::integral_constant<bool, has_fixed_size<nav_msgs::msg::Odometry>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<quadrotor_msgs::msg::Odometry>
  : std::integral_constant<bool, has_bounded_size<nav_msgs::msg::Odometry>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

...
class Init_SO3Command_seq
{
public:
  explicit Init_SO3Command_seq(::quadrotor_msgs::msg::SO3Command & msg)
  : msg_(msg)
  {}
  ::quadrotor_msgs::msg::SO3Command seq(::quadrotor_msgs::msg::SO3Command::_seq_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SO3Command_seq aux(::quadrotor_msgs::msg::SO3Command::_aux_type arg)
  {
    msg_.aux = std::move(arg);
    return Init_SO3Command_seq(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SO3Command_aux kom(::quadrotor_msgs::msg::SO3Command::_kom_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SO3Command_kr orientation(::quadrotor_msgs::msg::SO3Command::_orientation_type arg)
  {

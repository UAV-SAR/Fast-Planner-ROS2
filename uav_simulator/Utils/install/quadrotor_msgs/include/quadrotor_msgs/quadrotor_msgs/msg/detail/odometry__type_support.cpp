...
{
  new (message_memory) quadrotor_msgs::msg::Odometry(_init);
}

void Odometry_fini_function(void * message_memory)
{
  auto typed_message = static_cast<quadrotor_msgs::msg::Odometry *>(message_memory);
  typed_message->~Odometry();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Odometry_message_member_array[5] = {
  {
    "header",  // name
    ...
    offsetof(quadrotor_msgs::msg::Odometry, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(quadrotor_msgs::msg::Odometry, curodom),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(quadrotor_msgs::msg::Odometry, kfodom),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(quadrotor_msgs::msg::Odometry, kfid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(quadrotor_msgs::msg::Odometry, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Odometry_message_members = {
  ...
  5,  // number of fields
  sizeof(quadrotor_msgs::msg::Odometry),
...
{
  return &::quadrotor_msgs::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadrotor_msgs, msg, Odometry)() {
  return &::quadrotor_msgs::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
